angular.module('dashboardApp').controller("dailyAverageEmailValueRatingChartCtrl", function ($scope) {
    var data = {
        ...
        datasets: [
            {
                ...
                data: [1, 2, 2, 1, 2, 3, 2, 2, 1, 2, 3, 4, 3, 4, 5, 4, 3, 2, 3, 4, 3, 4, 5, 4, 3, 4, 5, 4, 3, 3, 4]
            },
            {
                ...
                data: [2, 3, 3, 4, 3, 4, 3, 2, 3, 4, 3, 2, 3, 2, 3, 2 ,3, 2, 3, 1, 2, 3, 2, 2, 1, 2, 3, 2, 1, 2, 3]
            }
        ]
    };
    ...
    var canvas = document.getElementById("dailyAverageEmailValueRatingChart");
    ...
    document.getElementById("dailyAverageEmailValueRatingChartLegend").innerHTML = legend;
});