angular.module('dashboardApp').controller("overallMoraleRatingChartCtrl", function ($scope) {
    var data = {
    ...
    var canvas = document.getElementById("overallMoraleRatingChart");
    ...
    document.getElementById("overallMoraleRatingChartLegend").innerHTML = legend;
});